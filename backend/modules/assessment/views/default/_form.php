        ...
        <div class='col-sm-12 col-md-12'>
            <div class="survey-container  ">
                ...
                echo Html::beginTag('div', ['class' => 'text-center survey-btn addQFixed']);
                    ...
                    echo Html::a('<i class="icofont-page"></i> <span>'.Yii::t('survey','Comment box').'</span>' , Url::toRoute(['question/create', 'id' => $survey->survey_id,'type'=>8]), ['class' => '', 'alt' => Yii::t('survey','Comment box'), 'title' => Yii::t('survey','Comment box')]);
