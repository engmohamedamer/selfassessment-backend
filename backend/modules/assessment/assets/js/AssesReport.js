            ...
            ></v-progress-circular>
                ...
                <div class="row sectiontitle report-title" data-html2canvas-ignore="true">
                    ...
                    <v-col cols="6" class='actionBtns'>
                      <a class="btn secBtn" :href='"/assessment/default/view?id=" + SurveyId'></i> العودة للإستبيان</a>
                    </v-col>
                </div>
                                ...
                                <v-item>
                                    ...
                                    >
                                        <div class="d-flex flex-no-wrap justify-space-between align-center col-12">
                                            ...
                                            <div>
                                                <p class="d-block mb-1 brandPrimColor ">اسم المؤسسة: <span class="brandPTextColor">{{theme.organization.name}}</span></p>
                                                <p class="d-block mb-1 brandPrimColor">عنوان المؤسسة: <span class="brandPTextColor">{{theme.organization.address}}</span></p>
                                                <p class="d-block mb-1 brandPrimColor">عن المؤسسة: <span class="brandPTextColor">{{theme.organization.about}}</span></p>
                                            </div>
                                            <v-avatar
                                                class="ma-3"
                                                size="125"
                        ...
                        <div class="fullWidth eight columns">
                            <div class="projectFactsWrap ">
                                ...
                                <div class="item wow fadeInUpBig animated animated" data-number="246" style="visibility: visible;">
                                    ...
                                    <p>وقت الإستبيان
                                        <br>
                                        الوقت المحدد: {{reportGeneralInfo.survey_time_to_pass}} دقيقة
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <v-data-table class="mb-5 mt-5"
                            ...
                            :custom-filter="customFilter">
                                ...
                                <v-alert slot="no-results" :value="true" color="error" icon="mdi-warning">
                                    لا توجد نتائج لهذا البحث   {{search}}
                                </v-alert>
                        </v-data-table>
                    </v-card>
                </div>
