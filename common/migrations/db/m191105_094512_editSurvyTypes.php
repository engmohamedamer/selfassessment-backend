...
/**
 * Class m191105_094512_editSurvyTypes
 */
class m191105_094512_editSurvyTypes extends Migration
{
    /**
     * {@inheritdoc}
     */
...
INSERT INTO `survey_type` VALUES ('5', 'Slider', 'Slider', 'Ask respondents to rate an item or question by dragging an interactive slider.', 'تقييم من خلال اختيا رنسبه من سليدر', 0, '7');
...
INSERT INTO `survey_type` VALUES ('11', 'File', 'ملف', 'Ask your respondent to attach file answers.', 'اطلب من المستفتى إرفاق الاجابة علي هيئة ملف', '1', '8');
    ...
    {
        echo "m191105_094512_editSurvyTypes cannot be reverted.\n";
