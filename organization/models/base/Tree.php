...
class Tree extends \kartik\tree\models\Tree
{
    ...
    /**
     * @inheritdoc
     * @return \organization\models\activequery\TreeQuery the active query used by this AR class.
     */
    public static function find()
    {
       return  $query = new \organization\models\activequery\TreeQuery(get_called_class());
