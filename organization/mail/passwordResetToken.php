        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                          <a href="http://organization.selfassest.localhost/sign-in/reset-password?token=pJSrRSJwVcpn" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">تغيير كلمة المرور</a>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td align="right" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              ...
              <p style="margin: 0;"><a href="<?php echo Html::a(Html::encode($resetLink), $resetLink) ?>" target="_blank"><?php echo Html::a(Html::encode($resetLink), $resetLink) ?></a></p>
            </td>
          </tr>
          <!-- end copy -->
